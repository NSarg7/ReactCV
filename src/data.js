   ...
   projects: [
      {
         ...
         doesShow: false,
         img: require(`./sass/assets/project-pics/PM-ok.png`),
      ...
      },
      {
         ...
         doesShow: false,
         img: require(`./sass/assets/project-pics/15puzzle-ok.png`),
      ...
      },
      {
         ...
         doesShow: false,
         img: require(`./sass/assets/project-pics/omnifood-ok.png`),
      ...
      },
      {
         ...
         doesShow: false,
         img: require(`./sass/assets/project-pics/natours-ok.png`),
